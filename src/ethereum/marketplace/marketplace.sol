...
contract designVoting {
    ...
    //Temp event
    event tempOutput(int256 _numerator, int256 _denominator);//, uint256 timestamp, uint256 expiry, uint256 balance);
    ...
    public payable
    {
        ...
        require(msg.value == _commitment * 1e18, "The announcement didn't receive the commitment.");
        ...
        //Commitment
        designes[j].balance = _commitment * 1e18;
        ...
        require(designes[j].vendor != address(0), "The vendor is set to 0.");
    ...
    public payable
    {
        ...
        //Check if the commitment parameter matches the commiment sent to the contract.
        require(msg.value == _commitment * 1e18, "The registration didn't receive the commitment.");
        
        //Check if the commitment is less than penalty
        require(_commitment * 1e18 >= designes[_designNo].taup, "The commitment should be greater than the penalty.");
