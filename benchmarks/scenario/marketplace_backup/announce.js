...
const SimpleState = require('./utils/marketplace-state');

/**
 * Workload module for initializing the SUT with various accounts.
 */
class Announce extends OperationBase {
    ...
    async submitTransaction() {
        let createArgs = this.simpleState.getAnnounceArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('announce', createArgs));
    }
}
