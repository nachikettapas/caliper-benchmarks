...
class OperationBase extends WorkloadModuleBase {
    ...
    async initializeWorkloadModule(workerIndex, totalWorkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        this.marketplaceState = this.createMarketplaceState();
    }

    /**
     * Performs the operation mode-specific initialization.
     * @return {MarketplaceState} the initialized MarketplaceState instance.
     * @protected
     */
    createMarketplaceState() {
        throw new Error('Marketplace workload error: "createMarketplaceState" must be overridden in derived classes');
    }
