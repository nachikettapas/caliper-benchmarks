...
class SimpleOpenWorkload extends WorkloadModuleBase {
    ...
    _generateWorkload() {
        ...
        for(let i= 0; i < this.roundArguments.txnPerBatch; i++) {
            ...
            workload.push({
                ...
                verb: 'announce',
                value: Web3.utils.toWei(this.roundArguments.commitment.toString(), "ether"),
                args: ["0x6d6168616d000000000000000000000000000000000000000000000000000000", this._getRandomTime(), this.roundArguments.commitment, this.roundArguments.manager, 0, 0, 0, 0],
                readOnly: false
            });
        }
        return workload;
    ...
    async initializeWorkloadModule(workerIndex, totalWorkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        if(!this.roundArguments.commitment) {
            throw new Error('marketplace.announce - the "commitment" argument is missing');
        }
